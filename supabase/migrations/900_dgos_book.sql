...
update public.partner_books
  ...
  },
  {
    ...
    "props": {
      ...
      "items": [
        ...
        {
          "chapter": "03",
          "title": "Un interlocuteur privilégié",
          "description": "CNAM, lapins, groupes de travail, axes stratégiques",
          "range": "Slides 10 – 13"
        },
        {
          "chapter": "04",
          "title": "Nos outils & rendez-vous",
          "description": "Events, plateforme, Médecins En Grève",
          "range": "Slides 14 – 16"
        },
        {
          "chapter": "05",
          "title": "Communauté & engagement",
          "description": "Partenaires, charte, contact",
          "range": "Slides 17 – 19"
        }
      ]
    }
  ...
  },
  {
    ...
    "props": {
      ...
      "footnote": "Référents jeunes générations • Représentativité +++ face aux syndicats installés • Plusieurs vice-présidents de la FMF ou de syndicats verticaux • Chefs de service en place • Présence dans les commissions."
    }
  },
  {
    "type": "media",
  ...
  },
  {
    ...
    "props": {
      ...
      "subtitle": "Anticiper les prochaines réformes plutôt que de les subir. Un canal court avec la CNAM et la DGOS.",
      "pillars": [
        {
          "num": "01",
          "title": "Interlocuteur récurrent",
          "body": "Présence régulière aux bilatérales CNAM. Remontées et propositions en amont des cycles conventionnels, pas seulement en réaction.",
          "tags": [
            "Bilatérales",
            "Amont cyclique",
            "Commissions"
        ...
        },
        {
          ...
          "body": "Cible des prochaines réformes conventionnelles. Là où les autres syndicats représentent surtout les installés, nous portons la voix de celles et ceux qui vont installer leur cabinet dans les 10 ans.",
          "tags": [
            "Référents jeunes",
            "Représentativité +++",
            "90% < 10 ans DES"
        ...
        },
        {
          ...
          "body": "Hospitaliers déjà en commission, chefs de service, libéraux, mixtes. Aucun autre syndicat ne couvre autant de terrains d'exercice à la fois.",
          "tags": [
  ...
  },
  {
    ...
    "props": {
      ...
      "subtitle": "Un problème que personne ne veut prendre à bras-le-corps. Nous portons une proposition, prête à être défendue politiquement.",
      "benefits": [
        {
          "num": "27M",
          "title": "Le coût invisible des lapins",
          "body": "Chaque année, 27 millions de rendez-vous non honorés. Un cabinet médical sur cinq subit plusieurs lapins par semaine — perte sèche, désorganisation, tension avec les patients qui, eux, attendent des mois pour un créneau.",
          "items": [
        ...
        },
        {
          ...
          "body": "Un dispositif équilibré, testé sur notre base, qui responsabilise sans stigmatiser. Détail technique et modalités disponibles sur demande.",
          "items": [
          ...
          "arrow": "Un dossier concret, opérationnel, qui donne à la DGOS le soutien massif des médecins à quelques mois des prochaines élections professionnelles."
        }
      ],
      "closing": "Une victoire rapide, populaire chez les médecins, économiquement justifiée. Le genre de mesure qui laisse une trace positive après un passage au ministère."
    }
  },
  {
    "type": "workingGroups",
    "props": {
      ...
      "subtitle": "Un référent par groupe, déjà en place. Des propositions au gouvernement plutôt que des passages en force.",
      "groups": [
        {
      ...
      "footnote": "Référents jeunes prêts à être saisis par la DGOS pour co-construire des propositions plutôt que de commenter des textes finalisés. Représentativité +++ dans les commissions déjà couvertes par les membres du bureau."
    }
  },
  {
    "type": "strategy",
    "props": {
      ...
      "subtitle": "Une vision, une hiérarchisation des priorités, des propositions concrètes — pensées avec la contrainte budgétaire et politique.",
      "axes": [
        {
          "num": "01",
  ...
  },
  {
    ...
    "props": {
      ...
      "subtitle": "Notre canal de remontée le plus rapide. Plus court, plus qualitatif et plus fiable que les autres syndicats.",
      "features": [
        {
          "glyph": "📊",
          "tag": "Baromètre en temps réel",
          "title": "Médecins En Grève",
          "body": "Une plateforme mise en place lors des mouvements de 2024. Aujourd'hui, elle sert de baromètre permanent pour prendre le pouls du terrain : mesure de l'adhésion à une proposition, alerte sur une tension émergente, sondage flash sur un texte en préparation. Les remontées arrivent en 24 à 72 h, là où les canaux syndicaux classiques prennent des semaines.",
          "tools": [
            {
